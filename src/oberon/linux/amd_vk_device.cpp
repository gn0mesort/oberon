...
namespace oberon::linux {
  ...
  void amd_vk_device::select_device_queues(const vkfl::loader&, const VkSurfaceKHR, const VkPhysicalDevice,
  ...
  amd_vk_device::amd_vk_device(const vkfl::loader& dl, VkSurfaceKHR surface, const VkPhysicalDevice physical_device,
