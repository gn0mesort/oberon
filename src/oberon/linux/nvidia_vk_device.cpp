...
namespace oberon::linux {
  ...
  void nvidia_vk_device::select_device_queues(const vkfl::loader&, const VkSurfaceKHR, const VkPhysicalDevice,
  ...
  nvidia_vk_device::nvidia_vk_device(const vkfl::loader& dl, VkSurfaceKHR surface,
